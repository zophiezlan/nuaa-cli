...
> [!TIP] > **Auto-fix workflow**: When you open a PR, our automated workflow will automatically fix linting and formatting issues for you! The bot will commit any fixes directly to your PR branch. You can also run `make fix` locally before pushing to catch issues early.
