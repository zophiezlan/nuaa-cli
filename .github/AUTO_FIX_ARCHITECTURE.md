...
- **What it does**:
  1. ✅ Runs Black formatter on all Python code
  2. ✅ Runs Ruff with auto-fix on all Python code
...
✅ **Zero Manual Intervention**: Linting issues are automatically fixed
✅ **Never Block Releases**: Auto-fix runs before verification
...
✅ **Comprehensive**: Covers Python, Markdown, YAML, TOML, PowerShell
...
- `.github/workflows/release.yml` - Uses auto-fix action
...
🎉 **Linting issues will NEVER block releases again!** Every workflow automatically fixes issues before running any tests.
